    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-square-o"></i>AVI</li>
                            </ol>
                        </div>
                    </div>
                    <!-- page start-->
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" id="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="instrumento" class="form-control" id="id_instrumento" placeholder="Instrumento">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <script type="text/javascript">
            $("#cadastrar").click(function () {
                $.ajax({
                    url: "AdicionaAviServlet",
                    type: "POST",
                    data: {
                        "instrumento": $('#id_instrumento').val(),
                        "descricao": $('#id_descricao').val()
                    },
                    error: function () {
                        alert("Não foi possível cadastrar a Avaliação. Contate o Administrador do sistema.");
                    },
